...
public sealed partial class ChavAccentSystem : EntitySystem
{
    ...
    private static readonly Regex s_wordSplit = MyRegex();

    [GeneratedRegex("([\\p{P}\\p{Z}])", RegexOptions.IgnoreCase | RegexOptions.Compiled, "en-US")]
    ...
    public string Accentuate(string message)
    {
        ...
        for (int ti = 0; ti < tokens.Length; ++ti) {
            ...
            if(token.Equals(token, StringComparison.CurrentCultureIgnoreCase))
                continue;
