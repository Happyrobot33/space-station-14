...
public sealed partial class PlaytimeStatsWindow : FancyWindow
{
    ...
    private void PopulatePlaytimeData()
    {
        ...
        foreach (var rolePlaytime in rolePlaytimes)
        {
            ...
            AddRolePlaytimeEntryToTable(Loc.GetString(role.Name), playtime.ToString(), job: role); //starlight edit
        }
    ...
    private void AddRolePlaytimeEntryToTable(string role, string playtimeString, Color? textColor = null, JobPrototype? job = null) //starlight edit
    {
        if (TimeSpan.TryParse(playtimeString, out var playtime))
        {
            var entry = new PlaytimeStatsEntry(role, playtime, textColor, job, //starlight edit
